...
public class DisplayWeek extends JFrame implements ActionListener
{
  ...
  public DisplayWeek(String dbName, String tableName, String[] columnNames)
  {
  ...
  public static void main(String[] args)
  {
    ...
    String[] columnNames = {"ghin", "lastName", "firstName", "day"};
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if (command == helpItem)
    {
      new Help("This frame displays the weekly roster.");
    }
